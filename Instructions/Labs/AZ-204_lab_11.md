...
### <a name="exercise-4-application-insights-logging-with-net"></a>練習 4：Application Insights 的 .NET 記錄

#### <a name="task-1-configure-logging-for-a-net-api-app"></a>工作 1：設定 .NET API 應用程式的記錄
