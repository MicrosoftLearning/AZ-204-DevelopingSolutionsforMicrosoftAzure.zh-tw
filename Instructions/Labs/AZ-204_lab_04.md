...
1. 藉**由將 BlobContainerUrl** 和 **BlobSASToken** 屬性的值設定為**名為 images** Azure 儲存體 Blob 容器**的 URL** 屬性，以及您在此實驗室稍早記錄的 Blob SAS 令牌值。
...
1. 從AdventureWorksCosmosContext.cs**檔案的程式**代碼編輯器索引標籤，新增下列程序代碼：
