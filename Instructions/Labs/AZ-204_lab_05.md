...
1. 在 Cloud **Shell** 窗格中，選取 [上傳/下載] 按鈕（以折疊頁面表示，兩個箭頭指向右下角的相反方向），然後在下拉功能表中選取 **[上傳**]。

1. 在 [**開啟**] 對話框中，流覽至 **Allfiles （F）：\\Allfiles\\Labs\\05\\Starter\\func** 空白目錄，選取 [lab05.zip **]，然後選取 **[**開啟**]。

    > **注意**：這會將檔案向上復原到 ****/~Cloud Shell** 會話內的**目錄。
