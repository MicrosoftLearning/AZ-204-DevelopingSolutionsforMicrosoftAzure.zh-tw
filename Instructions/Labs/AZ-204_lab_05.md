...
#### <a name="task-3-create-a-container-registry-resource"></a>工作 3：建立 Container Registry 資源
...
#### <a name="task-4-store-container-registry-metadata"></a>工作 4：儲存 Container Registry 中繼資料
...
#### <a name="task-5-deploy-a-docker-container-image-to-container-registry"></a>工作 5：部署 Docker 容器映像至 Container Registry
...
#### <a name="task-1-enable-the-admin-user-in-container-registry"></a>工作 1：在 Container Registry 上啟用管理使用者
